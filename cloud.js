...
function sanitizeSupabaseUrl(raw) {
    ...
    try {
        ...
        // Keep only scheme + host (the bare project URL). This strips any
        // accidental path like /rest/v1, /auth/v1, /storage/v1, /graphql/v1,
        // or any other trailing path — preventing "Invalid path specified
        // in request URL" from the Supabase client.
        return parsed.protocol + '//' + parsed.host;
    } catch (e) {
        // Not a valid URL — fall back to removing known API suffixes + trailing slash
